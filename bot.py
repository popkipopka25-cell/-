...
FORMS = {
    ...
    "video": [
        ...
        {"q": "7. Что чаще монтируете? (ролики/рекламу/клипы и тд)", "type": "text"},
        ...
        {"q": "11. Скиньте 3 видео своих работ.", "type": "text"},
    ],
    "sender": [
        {"q": "1. Имя", "type": "text"},
        ...
        {"q": "5. Что делали чаще всего: рассылки, прогревы, вовлечение, работа с негативом?", "type": "text"},
